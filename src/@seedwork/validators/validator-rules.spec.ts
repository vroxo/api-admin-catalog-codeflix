...
describe('ValidatorRules Unit Tests.', () => {
  ...
  test('required validation rule', () => {
    ...
    arrange.forEach(({ value, property }) => assertIsInvalid({ 
      value, 
      property,
      rule: 'required',
    ...
    arrange.forEach(({ value, property }) => assertIsValid({
      value,
      property,
      rule: 'required',
      error: new ValidationError(`The ${property} is required.`)
  ...
  test('maxLength validation rule', () => {
    ...
    assertIsInvalid({
      ...
      rule: 'maxLength',
      error: new ValidationError(`The ${arrange.property} must be less or equal than ${max} characters.`),
      params: [ max ]
    });
